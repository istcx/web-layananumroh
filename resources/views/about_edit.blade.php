                    ...
                    <div class="row">
                        <div class="col col-md-6 col-sm-7 col-12">
                            <div class="contact-intro">
                                <ul>
                                    <li><i class="fi flaticon-envelope"></i> sumberbarokah.pt@gmail.com</li>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col col-xs-12">
                                <p class="copyright">&copy; 2024 PT. Sumber Barokah.</p>
                            </div>
                        </div>
                    </div>
                </div>
