...
@section('title')
    Beranda | Sumber Barokah Umrah dan Haji
@endsection
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 colsm-12">
                        <div class="wpo-about-text">
                            ...
                            <div class="btns">
                                @if($mitra)
    <a href="/{{ $mitra->username }}/about" class="theme-btn" tabindex="0">Baca Selengkapnya</a>
@endif
                                ...
                                <div class="container">
                                    <div class="entry-bottom">
                                        ...
                                        <div class="blog-thumb-text" style="margin: auto;">
                                            @if($mitra)
    <a href="/{{ $mitra->username }}/daftar/{{ $produk->slug }}"><span>Daftar</span></a>
@endif
                    ...
                    <div class="col-md-4 col-sm-12 col-12 custom-grid">
                        <div class="wpo-event-item">
                            <div class="wpo-event-text">
                                ...
                                <p>{!! $artikel->excerpt !!}</p>
                                @if($mitra)
    <a href="{{ route('detailArtikel', ['post' => $artikel->slug, 'mitra' => $mitra->username]) }}">Baca Selengkapnya...</a>
@endif
    ...
    <div class="blog-area section-padding">
        <div class="container">
            ...
            <div class="embed-responsive embed-responsive-16by9"
                ...
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31864.672522730965!2d114.54856523476565!3d-3.3294074999999816!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2de42335ee7382e7%3A0x23d45aaf0f562c7a!2sHome%20Ponsel!5e0!3m2!1sen!2sid!4v1717488735619!5m2!1sen!2sid"
...
@else
    <!-- Handle the case when $mitra is null -->
@endif
