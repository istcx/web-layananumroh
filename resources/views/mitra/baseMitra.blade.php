    ...
    <div class="wrapper">
        <div class="main-header">
            ...
            <div class="logo-header" data-background-color="white">
                ...
                <a href="#" class="logo">
                    <img src="{{ asset('assets/') }}../../assets/images/sumberbarokah.jpg"
            ...
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                    ...
                    <ul class="nav nav-primary">
                        ...
                        <li class="nav-item">
                            <a href="https://api.whatsapp.com/send/?phone=6285894634233&text=Halo Sumber Barokah, Saya ingin bertanya. &app_absent=0"
                                target="_blank">
